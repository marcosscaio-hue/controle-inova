    ...
    <>
      <div className="p-8 max-w-7xl mx-auto">
        <div className="flex items-start justify-between mb-8">
          <div>
            <h1 className="text-2xl font-semibold text-zinc-900 tracking-tight">Vendas</h1>
        ...
        {vendas.length > 0 && (
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="bg-white rounded-xl border border-zinc-200 p-4 shadow-xs">
              ...
              <p className="text-2xl font-bold text-zinc-900 mt-1">{vendas.length}</p>
            </div>
            <div className="bg-white rounded-xl border border-zinc-200 p-4 shadow-xs">
            ...
            <div className="bg-indigo-50/30 rounded-xl border border-indigo-100 p-4 shadow-xs">
              <p className="text-xs text-indigo-400">Faturamento total</p>
              <p className="text-2xl font-bold text-indigo-700 mt-1">{formatBRL(totalGeral)}</p>
            </div>
          </div>
        )}
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-zinc-100 bg-zinc-50/70">
                ...
                <th className="text-left px-5 py-3.5 text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">Produtos</th>
                <th className="text-left px-5 py-3.5 text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">Qtd. Total</th>
                <th className="text-right px-5 py-3.5 text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">Valor Total</th>
